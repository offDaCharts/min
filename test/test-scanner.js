...
describe('The scanner', function () {
  ...
  it('recognizes all reserved characters', function (done) {
    scan('test/data/symbols/reservedCharacters.min', function (tokens) {
      ...
      i(tokens[30]).should.equal(i({ kind: 'BLOCK', lexeme: 'BLOCK', line: 1, col: 31 }))
  ...
  it('recognizes indented blocks in conditionals and loops', function (done) {
    scan('test/data/workingPrograms/indentedBlocks.min', function (tokens) {
      ...
      i(tokens[3]).should.equal(i({kind:'NUMLIT',lexeme:'2',line:1,col:4}))
      i(tokens[4]).should.equal(i({kind:'NEWLINE',lexeme:'NEWLINE',line:1,col:5}))
      i(tokens[5]).should.equal(i({kind:'#',lexeme:'#',line:2,col:1}))
      i(tokens[6]).should.equal(i({kind:'ID',lexeme:'b',line:2,col:2}))
      i(tokens[7]).should.equal(i({kind:'=',lexeme:'=',line:2,col:3}))
      i(tokens[8]).should.equal(i({kind:'NUMLIT',lexeme:'4',line:2,col:4}))
      i(tokens[9]).should.equal(i({kind:'NEWLINE',lexeme:'NEWLINE',line:2,col:5}))
      i(tokens[10]).should.equal(i({ kind: '?', lexeme: '?', line: 3, col: 1 }))
      i(tokens[11]).should.equal(i({ kind: 'ID', lexeme: 'a', line: 3, col: 2 }))
      i(tokens[12]).should.equal(i({ kind: '>', lexeme: '>', line: 3, col: 3 }))
      i(tokens[13]).should.equal(i({ kind: 'ID', lexeme: 'b', line: 3, col: 4 }))
      i(tokens[14]).should.equal(i({ kind: 'BLOCK', lexeme: 'BLOCK', line: 3, col: 5 }))
      i(tokens[15]).should.equal(i({ kind: 'INDENT', lexeme: 'INDENT', line: 4, col: 1 }))
      i(tokens[16]).should.equal(i({ kind: '\'', lexeme: '\'', line: 4, col: 5 }))
      i(tokens[17]).should.equal(i({ kind: 'STRLIT', lexeme: '"hello world"', line: 4, col: 6 }))
      i(tokens[18]).should.equal(i({ kind: 'NEWLINE', lexeme: 'NEWLINE', line: 4, col: 7 }))
      i(tokens[19]).should.equal(i({ kind: 'DEDENT', lexeme: 'DEDENT', line: 5, col: 1 }))
      i(tokens[20]).should.equal(i({ kind: ':', lexeme: ':', line: 5, col: 1 }))
      i(tokens[21]).should.equal(i({ kind: 'BLOCK', lexeme: 'BLOCK', line: 5, col: 2 }))
      i(tokens[22]).should.equal(i({ kind: 'INDENT', lexeme: 'INDENT', line: 6, col: 1 }))
      i(tokens[23]).should.equal(i({ kind: '%', lexeme: '%', line: 6, col: 5 }))
      i(tokens[24]).should.equal(i({ kind: '#', lexeme: '#', line: 6, col: 6 }))
      i(tokens[25]).should.equal(i({ kind: 'ID', lexeme: 'i', line: 6, col: 7 }))
      i(tokens[26]).should.equal(i({ kind: '=', lexeme: '=', line: 6, col: 8 }))
      i(tokens[27]).should.equal(i({ kind: 'NUMLIT', lexeme: '0', line: 6, col: 9 }))
      i(tokens[28]).should.equal(i({ kind: ',', lexeme: ',', line: 6, col: 10 }))
      i(tokens[29]).should.equal(i({ kind: 'ID', lexeme: 'i', line: 6, col: 11 }))
      i(tokens[30]).should.equal(i({ kind: '<', lexeme: '<', line: 6, col: 12 }))
      i(tokens[31]).should.equal(i({ kind: 'NUMLIT', lexeme: '5', line: 6, col: 13 }))
      i(tokens[32]).should.equal(i({ kind: ',', lexeme: ',', line: 6, col: 14 }))
      i(tokens[33]).should.equal(i({ kind: 'ID', lexeme: 'i', line: 6, col: 15 }))
      i(tokens[34]).should.equal(i({ kind: '+=', lexeme: '+=', line: 6, col: 16 }))
      i(tokens[35]).should.equal(i({ kind: 'NUMLIT', lexeme: '1', line: 6, col: 18 }))
      i(tokens[36]).should.equal(i({ kind: 'BLOCK', lexeme: 'BLOCK', line: 6, col: 19 }))
      i(tokens[37]).should.equal(i({ kind: 'INDENT', lexeme: 'INDENT', line: 7, col: 1 }))
      i(tokens[38]).should.equal(i({ kind: '\'', lexeme: '\'', line: 7, col: 9 }))
      i(tokens[39]).should.equal(i({ kind: 'STRLIT', lexeme: '"hello 5 times"', line: 7, col: 10 }))
      i(tokens[40]).should.equal(i({ kind: 'NEWLINE', lexeme: 'NEWLINE', line: 7, col: 11 }))
      i(tokens[41]).should.equal(i({ kind: 'DEDENT', lexeme: 'DEDENT' }))
      i(tokens[42]).should.equal(i({ kind: 'DEDENT', lexeme: 'DEDENT' }))
      i(tokens[43]).should.equal(i({ kind: 'EOF', lexeme: 'EOF' }))
      done()
    })
  })
